...
| [`flare-core-web-app`](./flare-core-web-app) | Web (Vue 3) | `flare-core-typescript-sdk` (web) | Full IM workbench |
...
| App | Platform | SDK |
|-----|----------|-----|
| [`flare-core-rn-app`](./flare-core-rn-app) | React Native | `flare-core-typescript-sdk` (react-native) |
...
| [`flare-core-uni-app`](./flare-core-uni-app) | uni-app | `flare-core-typescript-sdk` (uni-app) |
| [`flare-core-electron-app`](./flare-core-electron-app) | Electron | `flare-core-typescript-sdk` (web) |
| [`flare-core-tauri-app`](./flare-core-tauri-app) | Tauri | `flare-core-typescript-sdk/tauri` |
