...
|--------|--------|---------|
| `session` | `client` | `create`, `init`, `uninit`, `login`, `prepare`, `connect`, `updateAccessToken`, `setHeartbeatAppState`, `setHeartbeatNatTimeout`, `heartbeatEffectiveInterval`, `logout`, `dispose`, `hardReset`, `currentUserId`, `isConnected`, `sessionActive` |
