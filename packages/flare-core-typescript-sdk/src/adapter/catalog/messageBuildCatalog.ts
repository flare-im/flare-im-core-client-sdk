...
import { MessageBuildOp } from '../../model/message_build_op';
import { MessageContentType } from '../../model/message_content_type';

/** All supported quick-build operations for MessageBuilderApi. */
export const MESSAGE_BUILD_CATALOG: MessageBuildCatalogEntry[] = [
