...
interface SyncEventListener {
    ...
    fun onSyncServerStart(event: SyncEvent) {}
    /** Server conversation or message sync finished. */
    fun onSyncServerFinish(event: SyncEvent) {}
    /** Server conversation or message sync failed. */
    fun onSyncServerFailed(event: SyncEvent) {}
    /** Server sync progress changed. */
    fun onSyncProgress(event: ProgressEvent) {}
}
